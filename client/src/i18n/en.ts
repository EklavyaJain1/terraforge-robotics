...
export const en = {
  ...
  signUp: "Sign up",
  account: "Account",
  signInTitle: "Sign in — FarmBro Robotics",
  signInKicker: "Account",
  signInHeading: "Sign in to FarmBro.",
  signUpTitle: "Create account — FarmBro Robotics",
  signUpKicker: "Account",
  signUpHeading: "Create your FarmBro account.",
  accountTitle: "Account — FarmBro Robotics",
  accountKicker: "Account",
  accountHeading: "Your session.",
  accountSub: "Clerk holds the login. The FarmBro API only sees a verified session token.",
  accountLoading: "Loading account…",
  accountLoadError: "Could not load the account from the API.",
  accountName: "Name",
  accountEmail: "Email",
