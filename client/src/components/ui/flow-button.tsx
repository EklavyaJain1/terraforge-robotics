...
export function FlowButton({ text = "Modern Button", onClick }: { text?: string; onClick?: () => void }) {
  return (
    ...
    >
      ...
      {/* Circle */}
      <span className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-4 h-4 bg-[#1B8F6A] rounded-[50%] opacity-0 group-hover:w-[250px] group-hover:h-[250px] group-hover:opacity-100 transition-all duration-[800ms] ease-[cubic-bezier(0.19,1,0.22,1)]"></span>
